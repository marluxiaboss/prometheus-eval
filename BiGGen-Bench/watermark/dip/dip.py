...
class DIPConfig:
    ...
    def __init__(self, algorithm_config: dict, gen_model, 
                  model_config: ModelConfig, *args, **kwargs) -> None:
        """
    ...
    def __init__(self, algorithm_config: dict, gen_model, transformers_config: ModelConfig, *args, **kwargs) -> None:
        """
            ...
            Parameters:
                ...
                transformers_config (TransformersConfig): Configuration for the transformers model.
        """
        self.config = DIPConfig(algorithm_config, gen_model, transformers_config)
