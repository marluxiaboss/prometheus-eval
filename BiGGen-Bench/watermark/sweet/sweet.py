...
class SWEET_Utils:
    ...
    def __init__(self, config: SWEET_Config, *args, **kwargs):
        self.config = config
...
class SWEET_LogitsProcessor(LogitsProcessor):
    """Logits processor for SWEET algorithm, contains the logic to bias the logits."""

    def __init__(self, config: SWEET_Config, utils: SWEET_Utils, *args, **kwargs) -> None:
        """
    ...
    def __init__(self, algorithm_config: dict, gen_model, transformers_config, *args, **kwargs) -> None:
        """
            ...
            Parameters:
                ...
                transformers_config (TransformersConfig): Configuration for the transformers model.
        """
        self.config = SWEET_Config(algorithm_config, gen_model, transformers_config)
        self.utils = SWEET_Utils(self.config)
        self.logits_processor = SWEET_LogitsProcessor(self.config, self.utils)
